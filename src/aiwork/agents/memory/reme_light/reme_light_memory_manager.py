...
from .reme_light_prompts import (
    MEMORY_GUIDANCE_ZH,
    MEMORY_GUIDANCE_EN,
...
from ....config.timezone import get_user_timezone_name
...
class ReMeLightMemoryManager(BaseMemoryManager):
    ...
    def __init__(self, working_dir: str, agent_id: str):
        ...
        from aiwork.agents.tools import (
            read_file,
            write_file,
            edit_file,
        )  # noqa: PLC0415
    ...
    async def summarize(self, messages: list[Msg], **_kwargs) -> str:
        ...
        return await self._reme.summary_memory(
            ...
            timezone=get_user_timezone_name() or None,
