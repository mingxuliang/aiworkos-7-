...
"""ReMe Light memory prompts (file-based memory manager).

Used by ``ReMeLightMemoryManager`` to generate system prompts for
agents that read/write Markdown memory files.
"""
