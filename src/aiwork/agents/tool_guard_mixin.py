# -*- coding: utf-8 -*-
"""Tool-guard mixin for AiWorkAgent.
...
if TYPE_CHECKING:
    from aiwork.app.approvals.models import PendingApproval
    from aiwork.security.tool_guard.approval import ApprovalDecision
...
class ToolGuardMixin:
    ...
    def _init_tool_guard(self) -> None:
        ...
        from aiwork.app.approvals import get_approval_service
    ...
    async def _decide_guard_action(
        ...
        from aiwork.security.tool_guard.utils import log_findings
    ...
    async def _acting_auto_denied(
        ...
        from aiwork.security.tool_guard.approval import (
