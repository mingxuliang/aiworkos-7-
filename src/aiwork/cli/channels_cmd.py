...
# Template for `aiwork channels install <key>` stub (channel key substituted).
        ...
        **kwargs,
        ...
        return cls(
            ...
            filter_tool_messages=kwargs.get(
                ...
                getattr(config, "filter_tool_messages", True),
            ),
...
def configure_voice(
    ...
    welcome_greeting = click.prompt(
        ...
        or "Hi! This is AiWork. How can I help you?",
        type=str,
    )
...
def send_cmd(
    ...
    Complete Usage Flow:
      Step 1 - Query available sessions (REQUIRED):
        aiwork chats list --agent-id my_bot --channel console
      ...
      Step 3 - Send message using queried parameters:
        aiwork channels send --agent-id my_bot --channel console \\
    ...
    Examples with jq automation:
      ...
      # Send message
      aiwork channels send --agent-id bot --channel console \\
