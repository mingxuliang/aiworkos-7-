# -*- coding: utf-8 -*-
"""CLI command: run AiWork app on a free port in a native webview window."""
...
def desktop_cmd(
    ...
    """Run AiWork app on an auto-selected free port in a webview window.
    ...
    window without conflicting with an existing AiWork app instance.
    """
    ...
    click.echo(f"Starting AiWork app on {url} (port {port})")
